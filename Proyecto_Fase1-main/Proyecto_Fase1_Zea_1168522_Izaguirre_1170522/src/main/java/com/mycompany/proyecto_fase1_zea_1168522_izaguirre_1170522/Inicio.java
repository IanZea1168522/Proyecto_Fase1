...
public class Inicio extends javax.swing.JFrame {
        ...
        else 
        {
            ...
            if (indice != -1) 
            {
                if (contraseña.equals(plantilla.get(indice).split("\\|")[3])) 
                {
                    ...
                    //depende de si es admin o no, se manda a un JFrame u otro
                    if(plantilla.get(indice).split("\\|")[4].equals("0"))
                    {
                        new Perfil(plantilla.get(indice)).setVisible(true);
                        setVisible(false);
                    }
                    else
                    {
                        new MENU(plantilla.get(indice)).setVisible(true);
                        setVisible(false);
                    }
                } 
                else 
    ...
    private int buscarUsuario(String usuario, List<String> lista) 
    {
        ...
        {
            if (usuario.equals(lista.get(i).split("\\|")[0]) && lista.get(i).split("\\|")[9].equals("1")) 
            {
                return i;
            }
        }
